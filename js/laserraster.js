...
function Rasterizer(config) {
  ...
  var startgcode = $('#startgcode').val();
  var laseron = $('#laseron').val();
  var laseroff = $('#laseroff').val();
  var lasermultiply = $('#lasermultiply').val();
  var homingseq = $('#homingseq').val();
  var endgcode = $('#endgcode').val();
...
Rasterizer.prototype.figureIntensity = function() {
  ...
  if (lasermultiply <= 1) {
    ...
    var intensity = intensity * ( lasermultiply / 100);
    intensity = intensity.toFixed(0);
  }
...
Rasterizer.prototype.onFinish = function() {
  ...
  //   this.result += 'M81\n'; // Air Assist off
  // }
  this.result += '; End Gcode';
  this.result += endgcode;
